...
class Color(types.RGB):
    ...
    *directly* manipulated (e.g. by setting the red component).
    ...
    @classmethod
    def from_rgb_bytes(cls, r, g, b):  # -> Self:
        """
    ...
    @classmethod
    def from_yuv_bytes(cls, y, u, v):  # -> Self:
        """
    ...
    @classmethod
    def from_cmyk(cls, c, m, y, k):  # -> Self:
        """
    ...
    def __add__(self, other):  # -> Color | _NotImplementedType:
        ...

    def __radd__(self, other):  # -> Color | _NotImplementedType:
        ...

    def __sub__(self, other):  # -> Color | _NotImplementedType:
        ...

    def __rsub__(self, other):  # -> Color | _NotImplementedType:
        ...

    def __mul__(self, other):  # -> Color | _NotImplementedType:
        ...

    def __rmul__(self, other):  # -> Color | _NotImplementedType:
        ...
    ...
    def difference(self, other, method=...):  # -> Any:
        """
    ...
    def gradient(self,
                 ...
                 steps=...,
                 easing=...
                 ):  # -> Generator[Color | _NotImplementedType, Any, None]:
        """
